...
func (vm *VM) executeBinaryOperation(op code.Opcode) error {
	...
	case leftType == object.INTEGER_OBJ && rightType == object.INTEGER_OBJ:
		return vm.execueteBinaryIntegerOpration(op, left, right)

	case leftType == object.STRING_OBJ && rightType == object.STRING_OBJ:
		return vm.execueteBinaryStringOpration(op, left, right)
...
func (vm *VM) execueteBinaryIntegerOpration(op code.Opcode, left, right object.Object) error {
	leftValue := left.(*object.Integer).Value
	rightValue := right.(*object.Integer).Value
...
func (vm *VM) execueteBinaryStringOpration(op code.Opcode, left, right object.Object) error {
	if op != code.OpAdd {
